          ...
          {screen === 'home' && (
            <Screen id="home">
              <div style={{ textAlign: 'center', paddingTop: 14, paddingBottom: 10 }}>
                <p style={{ fontSize: 10, letterSpacing: '.26em', color: 'var(--muted)', marginBottom: 4 }}>{t('pranayamaPractice')}</p>
                <h1 className="font-serif" style={{ fontSize: 'clamp(1.9rem,7vw,2.8rem)', fontWeight: 600, color: 'var(--text)' }}>{t(basePractice.nameKey)}</h1>
              </div>
              {/* Practice chips */}
          ...
          {screen === 'session' && (
            <Screen id="session">
              <div style={{ textAlign: 'center', paddingTop: 8, paddingBottom: 6 }}>
                <p style={{ fontSize: 10, letterSpacing: '.26em', color: 'var(--muted)', marginBottom: 3 }}>{t('pranayamaPractice')}</p>
                <h1 className="font-serif" style={{ fontSize: 'clamp(1.6rem,5.5vw,2.3rem)', fontWeight: 600, color: 'var(--text)' }}>{t(practice.nameKey)}</h1>
              </div>
